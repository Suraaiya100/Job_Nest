    ...
    const applyHandler = async () => {
        try {
            ...
            if (!userData.resume){
                ...
                return toast.error("Please upload your resume in profile section to apply for job")
            }
        ...
        <>
            ...
            <div className="min-h-screen flex flex-col py-10 container px-4 2xl:px-20 mx-auto" >
                <div className="bg-white text-black rounded-lg w-full">
                    <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 mb-6 bg-purple-50 border border-purple-400 rounded-xl">
